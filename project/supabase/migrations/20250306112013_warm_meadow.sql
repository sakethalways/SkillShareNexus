...
ALTER TABLE connection_requests DROP POLICY IF EXISTS "Users can create their own connection request";
...
ALTER TABLE active_connections DROP POLICY IF EXISTS "Users can create connections they are part of";
